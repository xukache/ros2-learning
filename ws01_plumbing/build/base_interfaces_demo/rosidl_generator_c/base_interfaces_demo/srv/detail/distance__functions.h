...
#ifndef BASE_INTERFACES_DEMO__SRV__DETAIL__DISTANCE__FUNCTIONS_H_
#define BASE_INTERFACES_DEMO__SRV__DETAIL__DISTANCE__FUNCTIONS_H_
 ...
 * calls
 * base_interfaces_demo__srv__Distance_Request__init().
...
/**
 * It calls
 * base_interfaces_demo__srv__Distance_Request__fini()
 ...
 * base_interfaces_demo__srv__Distance_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * base_interfaces_demo__srv__Distance_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * base_interfaces_demo__srv__Distance_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces_demo
...
/**
 * It calls
 * base_interfaces_demo__srv__Distance_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces_demo
...
/**
 * It allocates the memory for the array and calls
 * base_interfaces_demo__srv__Distance_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_base_interfaces_demo
...
/**
 * It calls
 * base_interfaces_demo__srv__Distance_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BASE_INTERFACES_DEMO__SRV__DETAIL__DISTANCE__FUNCTIONS_H_
